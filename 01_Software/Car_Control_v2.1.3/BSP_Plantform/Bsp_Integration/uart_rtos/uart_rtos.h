 ...
 *
 * Features:
 *  - TX task at fixed period (e.g., 50 Hz)
 *  - RX task at fixed period (e.g., 50 Hz)
 *  - A lightweight DMA service task that pumps uart_poll_dma_tx()
...
/* Create tasks for this UART and (on first call) a shared DMA service task */
